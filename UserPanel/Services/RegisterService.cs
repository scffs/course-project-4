...
public abstract class RegisterService(HttpClient httpClient) : BaseService(httpClient)
{
    ...
    DateTime birthday, string login, string password, string avatarUrl)
  {
    ...
    var payload = new { name, surname, patronymic, sex, birthday, login, password, avatarUrl };
